...
- **Вход** — по пинкоду (ровно 6 цифр) или паролю; у новых пользователей по умолчанию пинкод. Тип входа задаётся в админ-панели при создании пользователя и при смене учётных данных. Администратор из `seed` входит по паролю.
